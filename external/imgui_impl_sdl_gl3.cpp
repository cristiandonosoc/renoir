...
#include <SDL.h>
#include <SDL_syswm.h>
#include <external/GL/gl3w.h>    // This example is using gl3w to access OpenGL functions (because it is small). You may use glew/glad/glLoadGen/etc. whatever already works for you.
